...
import com.ch3d.xreminderx.reminders.model.NullReminderEntry;
import com.ch3d.xreminderx.reminders.model.ReminderEntry;
import com.ch3d.xreminderx.reminders.model.ReminderFactory;
import com.ch3d.xreminderx.reminders.model.ReminderType;
import com.ch3d.xreminderx.reminders.notifications.AlarmReceiver;
import com.ch3d.xreminderx.reminders.provider.DBUtils;
import com.ch3d.xreminderx.reminders.provider.RemindersContract;
import com.ch3d.xreminderx.reminders.provider.RemindersProvider;

/**
 * Protocol #1<br/>
 * <li>int protocolVersion</li> <li>int id</li> <li>long ts</li> <li>long alarm_ts</li> <li>String text</li> <br/>
 * <br/>
 * Protocol #2<br/>
 * <li>int protocolVersion</li> <li>int id</li> <li>long ts</li> <li>long alarm_ts</li> <li>String text</li> <li>
 * <b>String contactUri</b></li> <li><b>int type</b></li><br/>
 * <br/>
 * Protocol #3<br/>
 * <li>int protocolVersion</li> <li>int id</li> <li>long ts</li> <li>long alarm_ts</li> <li>String text</li> <li>
 * <b>String contactUri</b></li> <li><b>int type</b></li> <li><b>int ongoing</b></li> <li><b>int silent</b></li><br/>
 */
public class ReminderUtils
{
	...
	public static final int		FORMAT_DATE			= DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_SHOW_WEEKDAY
															| DateUtils.FORMAT_SHOW_YEAR
															| DateUtils.FORMAT_ABBREV_WEEKDAY
															| DateUtils.FORMAT_ABBREV_MONTH;

	public static final int		FORMAT_DATETIME		= DateUtils.FORMAT_SHOW_TIME | DateUtils.FORMAT_SHOW_DATE
	...
	public static Bitmap fetchThumbnail(final Context context, final Uri contactUri, final Bitmap defaultImg)
	{
		if(contactUri != null)
		{
			...
			try
			{
				c = context.getContentResolver().query(contactUri, new String[] {ContactsContract.Contacts.PHOTO_ID},
						null, null, null);
	...
	{
		return com.ch3d.xreminderx.reminders.utils.DateUtils.getDate(context, ts);
	}

	public static String formatDateTime(final Context context, final long ts)
	{
		return com.ch3d.xreminderx.reminders.utils.DateUtils.getDate2(context, ts);
	}
	...
	public static boolean hasAddressbookContact(final Context context, final Uri contactUri)
	{
		...
		try
		{
			c = context.getContentResolver().query(contactUri, new String[] {ContactsContract.Contacts.PHOTO_ID}, null,
					null, null);
			if(c != null)
			{
				return c.getCount() > 0;
	...
	public static ReminderEntry parse(final Cursor cursor)
	{
		...
		final ReminderEntry entry = ReminderFactory
				.create(cursor.getInt(RemindersContract.Indexes.PROTOCOL),
						cursor.getInt(RemindersContract.Indexes._ID), cursor.getInt(RemindersContract.Indexes.TYPE),
