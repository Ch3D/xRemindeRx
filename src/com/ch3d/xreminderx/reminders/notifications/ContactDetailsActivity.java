...
public class ContactDetailsActivity extends Activity
{
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		final PendingIntent operation = ReminderUtils.getPendingAlarmOperation(this, reminder.getId());
		...
		cdIntent.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY | Intent.FLAG_ACTIVITY_EXCLUDE_FROM_RECENTS);
