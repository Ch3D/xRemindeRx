...
public class RingerService extends Service implements Callback
{
	...
	private final PhoneStateListener	mPhoneStateListener	= new PhoneStateListener()
															{
																		...
																		final String ignored)
																{
																	...
																	// alarm fires. When
																	// we register onCallStateChanged, we get the
																	// initial in-call state
																	// which kills the alarm. Check against the initial
																	// call state so
	...
	private void startAlarm(final MediaPlayer player) throws java.io.IOException, IllegalArgumentException,
